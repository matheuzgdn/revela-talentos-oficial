  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await base44.entities.AthleteVideo.create({
        ...
        video_url: file_url,
        thumbnail_url: file_url, // Would need separate thumbnail generation
    ...
    <AnimatePresence>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-800">
          <button onClick={() => { onClose(); resetForm(); }} className="text-white">
            <X className="w-6 h-6" />
          </button>
        ...
        <div className="flex-1 overflow-auto p-4">
          {step === 1 && (
            ...
            >
              ...
              <button
                ...
                className="w-full max-w-sm aspect-video bg-gray-900 border-2 border-dashed border-gray-700 rounded-2xl flex flex-col items-center justify-center gap-4 hover:border-cyan-500 transition-colors"
              >
                ...
                <div className="text-center">
                  <p className="text-white font-semibold mb-1">Selecionar Vídeo</p>
                  <p className="text-gray-400 text-sm">Toque para escolher um vídeo</p>
                </div>
              </button>
          ...
          {step === 3 && (
            <motion.div
              ...
              className="flex flex-col items-center justify-center h-full"
            >
              <div className="w-24 h-24 bg-gradient-to-r from-green-500 to-emerald-500 rounded-full flex items-center justify-center mb-6">
                <Check className="w-12 h-12 text-white" strokeWidth={3} />
              </div>
              <h3 className="text-2xl font-bold text-white mb-2">Vídeo Enviado!</h3>
          ...
          <div className="p-4 border-t border-gray-800">
            {uploading ? (
              ...
              <Button
                ...
                className="w-full py-6 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-black font-bold text-lg rounded-xl"
              >
