...
const QuickActions = ({ onNavigate }) => {
  const actions = [
    ...
    { title: "Agendar Reunião", icon: Calendar, action: () => onNavigate('calendario'), color: "bg-purple-600 hover:bg-purple-700" },
    { title: "Ver Relatórios", icon: BarChart, action: () => onNavigate('relatorios'), color: "bg-cyan-600 hover:bg-cyan-700" },
    { title: "Importar Leads", icon: FileSpreadsheet, action: () => { toast.info("Funcionalidade de importação de leads em breve!"); }, color: "bg-yellow-600 hover:bg-yellow-700" },
  ];
    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm">Tudo que você precisa para vender mais</p>
        </div>
      </div>
