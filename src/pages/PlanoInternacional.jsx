...
export default function EC10TrialHub() {
  ...
  useEffect(() => {
    const loadPageContent = async () => {
      try {
        const allContent = await appClient.entities.InternationalPlan.filter({ is_active: true }, "order");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await appClient.entities.InternationalLead.create(leadData);
      
      toast.success("InscriÃ§Ã£o realizada com sucesso! Nossa equipe entrarÃ¡ em contato em breve.");
      setFormData({
  ...
  const COUNTRIES = [
    ...
    { name: "EslovÃ¡quia", imageUrl: "https://static.mundoeducacao.uol.com.br/mundoeducacao/2022/11/bandeira-da-eslovaquia.jpg" },
    { name: "BÃ³snia", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/b/bf/Flag_of_Bosnia_and_Herzegovina.svg" },
    { name: "Alemanha", imageUrl: "https://s5.static.brasilescola.uol.com.br/be/2020/10/bandeira-da-alemanha.jpg" },
    { name: "Ãustria", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/41/Flag_of_Austria.svg/330px-Flag_of_Austria.svg.png" },
    { name: "CroÃ¡cia", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1b/Flag_of_Croatia.svg/330px-Flag_of_Croatia.svg.png" },
    ...
    { name: "Emirados Ãrabes", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cb/Flag_of_the_United_Arab_Emirates.svg/960px-Flag_of_the_United_Arab_Emirates.svg.png" },
    { name: "China", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/f/fa/Flag_of_the_People%27s_Republic_of_China.svg" },
    { name: "ItÃ¡lia", imageUrl: "https://upload.wikimedia.org/wikipedia/en/thumb/0/03/Flag_of_Italy.svg/250px-Flag_of_Italy.svg.png" },
    { name: "Andorra", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/1/19/Flag_of_Andorra.svg" },
    { name: "RepÃºblica Tcheca", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/c/cb/Flag_of_the_Czech_Republic.svg" },
    { name: "FinlÃ¢ndia", imageUrl: "https://upload.wikimedia.org/wikipedia/commons/b/bc/Flag_of_Finland.svg" },
    { name: "SuÃ­Ã§a", imageUrl: "https://img.freepik.com/fotos-premium/bandeira-da-suica-com-papel-antigo-vintage_39526-268.jpg" },
  ...
  return (
    <main className="min-h-screen bg-black text-white relative">
      {/* VÃ­deo de fundo contÃ­nuo sem som */}
      ...
      <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-[#0b0c0f]/60 relative">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-6 text-sm">
            ...
            <a href="#inscricao" className="hover:text-white">InscriÃ§Ã£o</a>
          </nav>
          <div>
      ...
      {/* HERO COM VÃDEO HERO COM CONTROLES */}
        ...
        <div className="relative z-20 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 md:py-20">
          <div className="grid md:grid-cols-2 gap-8 items-center min-h-[80vh]">
            <div>
              ...
              <p className="mt-4 text-zinc-300 text-base md:text-lg">A partir de 18 anos. Sua chance real de jogar na Europa com preparaÃ§Ã£o, avaliaÃ§Ã£o e acompanhamento completo.</p>
              ...
              <div className="mt-6 text-xs text-zinc-400 flex items-center gap-2"><ShieldCheck className="w-4 h-4"/> CNPJ: 54.433.892/0001-43 â€¢ PolÃ­tica de Privacidade â€¢ Termos</div>
            </div>
            
            {/* VÃDEO HERO COM CONTROLES DE SOM */}
            <div className="flex justify-center">
              <div className="rounded-2xl bg-zinc-900/80 ring-1 ring-zinc-800/80 shadow-[0_10px_30px_-10px_rgba(0,0,0,.6)] hover:shadow-[0_12px_40px_-8px_rgba(0,0,0,.75)] transition-all duration-300 p-0 overflow-hidden w-80 md:w-96">
                <div className="aspect-[9/16] w-full bg-gradient-to-br from-zinc-900 to-zinc-800 relative">
                  ...
                  />
                  {/* Overlay responsivo para indicar vÃ­deo */}
      ...
      {/* COUNTRIES */}
      <Section id="onde-estamos" title="Onde estamos" subtitle="Destinos com oportunidades e janelas de avaliaÃ§Ã£o abertas">
      ...
      {/* HOW IT WORKS */}
      <Section id="como-funciona" title="Como funciona" subtitle="Do envio do material Ã  assinatura do contrato">
        <div className="grid md:grid-cols-3 gap-4">
          {[
            { n: 1, t: "InscriÃ§Ã£o e triagem", d: "Perfil, posiÃ§Ã£o e material de jogo." },
            { n: 2, t: "Mentoria preparatÃ³ria", d: "Treinos, currÃ­culo esportivo e mÃ­dia." },
            { n: 3, t: "SeleÃ§Ã£o de destino", d: "PaÃ­s, clube e calendÃ¡rio da janela." },
            { n: 4, t: "AvaliaÃ§Ã£o presencial", d: "Tryout / perÃ­odo de testes acompanhado." },
            { n: 5, t: "Proposta e assinatura", d: "Com suporte jurÃ­dico especializado." },
            { n: 6, t: "Acompanhamento", d: "AdaptaÃ§Ã£o e performance pÃ³s-chegada." },
          ].map((s) => (
      ...
      <Section id="planos" title="Plano de Carreira Internacional" subtitle="Escolha a rota que combina com o seu momento">
        <div className="grid md:grid-cols-2 gap-6">
          <Card className={`p-6 ${formData.plan_type === "carreira_internacional" ? "ring-sky-500/50" : ""}`}>
            <div className="flex items-start justify-between gap-4">
              <div>
                ...
                <p className="text-zinc-400">A partir de <span className="text-white font-semibold">â‚¬200</span> (pagamento Ãºnico)</p>
              </div>
              <div className="text-xs text-sky-300 bg-sky-500/10 ring-1 ring-sky-500/20 px-3 py-1 rounded-full">PreparatÃ³rio</div>
            </div>
            <ul className="mt-4 space-y-3 text-sm">
              {["Mentoria preparatÃ³ria (performance + currÃ­culo)", "Assessoria de treinos e calendÃ¡rio", "Marketing pessoal e mÃ­dia", "Planejamento de embarque em atÃ© 10 meses"].map((it, i) => (
            ...
            <div className="mt-6 flex items-center gap-3">
              ...
              <span className="text-xs text-zinc-500">*NÃ£o inclui passagens, vistos e seguro.</span>
            </div>
          </Card>
          ...
          <Card className={`p-6 ${formData.plan_type === "avaliacao" ? "ring-sky-500/50" : ""}`}>
            <div className="flex items-start justify-between gap-4">
              <div>
                <h3 className="text-xl font-bold text-white">Plano de AvaliaÃ§Ã£o Internacional</h3>
                <p className="text-zinc-400">Embarque imediato â€” A partir de <span className="text-white font-semibold">â‚¬1.500</span></p>
              </div>
              <div className="text-xs text-emerald-300 bg-emerald-500/10 ring-1 ring-emerald-500/20 px-3 py-1 rounded-full">AvaliaÃ§Ã£o</div>
            </div>
            <ul className="mt-4 space-y-3 text-sm">
              {["AlimentaÃ§Ã£o e estadia durante a avaliaÃ§Ã£o", "Assessoria no paÃ­s de destino", "Embarque na prÃ³xima janela de transferÃªncias", "Marketing e apresentaÃ§Ã£o ao clube"].map((it, i) => (
      ...
      {/* DEPOIMENTOS */}
      <Section id="depoimentos" title="Depoimentos" subtitle="Resultados reais de atletas que confiaram no nosso mÃ©todo">
      ...
      <section id="inscricao" className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10">
        <div className="mb-6">
          <h2 className="text-2xl md:text-3xl font-bold tracking-tight text-white">InscriÃ§Ã£o</h2>
        ...
        <div className="grid md:grid-cols-5 gap-6">
          <div className="md:col-span-3">
            <Card className="p-6">
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  <div>
                    <label className="text-sm text-zinc-400">PosiÃ§Ã£o</label>
                  ...
                  <div>
                    <label className="text-sm text-zinc-400">PaÃ­s de interesse</label>
                ...
                <label className="flex items-start gap-3 text-sm text-zinc-300">
                  ...
                  <span>Concordo em ser contatado(a) pela EC10 para fins de avaliaÃ§Ã£o esportiva e entendo a PolÃ­tica de Privacidade (LGPD).</span>
                </label>
                ...
                <div className="flex items-center gap-3">
                  <button type="submit" disabled={!formData.lgpd_consent || isSubmitting} className={`inline-flex items-center justify-center gap-2 rounded-2xl px-5 py-3 font-semibold tracking-wide bg-gradient-to-r from-sky-500 to-blue-500 text-white hover:from-sky-400 hover:to-blue-400 ${(!formData.lgpd_consent || isSubmitting) ? 'opacity-60 cursor-not-allowed' : ''}`}>
                    {isSubmitting ? <Loader2 className="w-5 h-5 animate-spin" /> : "Concluir inscriÃ§Ã£o"}
                  </button>
          ...
          <div className="md:col-span-2 flex flex-col gap-4">
            <Card className="p-6">
              ...
              <p className="text-white font-semibold">Segâ€“Sex 09:00â€“18:00 (CET)</p>
              <div className="mt-3 flex items-center gap-3 text-sm text-zinc-300">
                <MapPin className="w-4 h-4"/> R. AmÃ©rico Luz, 521 â€” Gutierrez, Belo Horizonte-MG
              </div>
            ...
            <Card className="p-6">
              ...
              <p className="text-zinc-300">EC10 Talentos â€¢ CNPJ 54.433.892/0001-43</p>
              <div className="mt-2 text-xs text-zinc-500">*Alguns serviÃ§os nÃ£o incluem passagens aÃ©reas, vistos, taxas consulares e seguro. Consulte condiÃ§Ãµes.</div>
            </Card>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-zinc-800/80 relative z-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-zinc-400">Â© {new Date().getFullYear()} EC10 Talentos â€” Todos os direitos reservados.</p>
          <div className="flex items-center gap-4 text-sm">
            <a className="hover:text-white" href="#">PolÃ­tica de Privacidade</a>
