...
const PlanoCarreiraLandingPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.lgpd_consent) {
      toast.error("�0 necessário aceitar os termos LGPD para prosseguir.");
      return;
    }
  ...
  const countries = [
    ...
    { name: 'SUÍ�!A', flag: 'https://cdn.jsdelivr.net/gh/lipis/flag-icons/flags/4x3/ch.svg' },
    ...
    { name: 'B�SNIA', flag: 'https://cdn.jsdelivr.net/gh/lipis/flag-icons/flags/4x3/ba.svg' },
    { name: 'FINL�NDIA', flag: 'https://cdn.jsdelivr.net/gh/lipis/flag-icons/flags/4x3/fi.svg' },
            ...
            <div className="max-w-4xl mx-auto flex flex-col gap-6">
              ...
              <div className="pillar-item reveal-on-scroll rounded-2xl p-6 md:p-8">
                ...
                <div className="pillar-content flex items-center gap-6">
                  ...
                  <div>
                    <h3 className="text-xl md:text-2xl font-bold uppercase mb-2">Mentoria �x��</h3>
