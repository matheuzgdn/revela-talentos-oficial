...
const InicioView = ({ contents, onPlay, onNav }) => {
    ...
    const slides = [
        ...
        { title: 'Aulas en vivo', desc: 'Proyectos y planos de carrera.', badge: 'ATENCION', img: 'https://static.wixstatic.com/media/933cdd_f02fd6b9fa5f46d89e8b4ab5e3f89f1f~mv2.jpg' },
    ];
