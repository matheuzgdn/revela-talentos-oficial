      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4 py-20 pb-32">
        <div className="max-w-4xl w-full text-center mb-8">
          ...
          <h1 className="text-3xl md:text-5xl font-black mb-4 leading-tight">
            Se voce nao puder estar presente no dia, assista ao <span className="bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">resumo completo da apresentacao</span>
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Evite distracoes e acompanhe com calma os pilares da metodologia Revela Talentos, os beneficios da parceria e a jornada pensada para o desenvolvimento do seu filho.
          </p>
        </div>
        ...
        <div className="mt-8 flex items-center justify-center gap-2 text-gray-400 text-sm">
          <Shield className="w-4 h-4 text-cyan-500" /> Site oficial e seguro - Revela Talentos
        </div>
