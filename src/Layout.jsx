...
function LayoutInner({ children, currentPageName }) {
  ...
  const isLandingPage = ['escola-parceira', 'vsl-escola-parceira', 'evento', 'vsl-evento', 'cases-sucesso-atletas', 'libertacademy', 'libertacademy-school'].includes(currentPageName);
